/**
 * Paste list fix: when pasting into textareas, preserve markdown-style
 * formatting. Intercepts paste, reads text/html when present, and converts it
 * to plain text with newlines and list markers (1. / -) so lists and
 * paragraphs survive instead of being flattened by the browser.
 *
 * Importing this module installs a global paste listener once.
 */

/**
 * Converts an HTML string into markdown-style text.
 * - <ol><li>...</li></ol> -> "1. ...\n2. ...\n"
 * - <ul><li>...</li></ul> -> "- ...\n"
...
/** Inserts text at the cursor in a textarea, replacing any selection. */
...
/** Installs the global paste handler (idempotent). */
export function installPasteListFix() {
    if (installed) return;
    installed = true;
    document.addEventListener('paste', function (e) {
        ...
        // Only intercept when rich HTML is present so we can preserve structure.
